...
// selectElement(".blog-off-canvas .closebtn").addEventListener("click", function (e) {
//   e.stopPropagation(), selectElement(".blog-off-canvas").classList.remove("show");
// })
// selectAllElement(".blog-off-canvas .lwptoc_item .lwptoc_item_label").forEach((e) => {
//   e.addEventListener("click", function (i) {
//     i.stopPropagation(), selectElement(".blog-off-canvas").classList.remove("show");
//   });
// })
...
function loadedFunction() {
  document.addEventListener("DOMContentLoaded", function(){
      ...
      selectElement(".blog-toggler-btn").addEventListener("click", function (e) {
          e.stopPropagation(), selectElement(".blog-off-canvas").classList.add("show");
          console.log('after load working');
      })
      selectElement(".blog-off-canvas .closebtn").addEventListener("click", function (e) {
        e.stopPropagation(), selectElement(".blog-off-canvas").classList.remove("show");
      })
      ...
      selectAllElement(".sidebar .lwptoc .lwptoc_item a").forEach((e) => {
        e.addEventListener("click", function (i) {
          const nodeItem = i.target.parentElement;
